...
export default function SMSManager({ onSuccess }) {
  ...
  return (
    <div className="card" style={{ marginBottom: 22 }}>
      <div className="card-title">Gestion de <em>SMS</em></div>
      ...
      <div style={{ 
        ...
        <strong>Como enviar un SMS real</strong>
        ...
        <p style={{ marginTop: 8, fontSize: 12, color: 'var(--text-muted)' }}>
          El SMS sera procesado automaticamente y aparecera en el historial abajo.
        </p>
      </div>
